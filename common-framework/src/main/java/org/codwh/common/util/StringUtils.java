...
public class StringUtils {
     ...
     *
     * @param input  : 输入需要展示的字符串
     * @param length : 该字符串的最大长度，如果超过长度时，添加.....
     * @return
     */
    ...
    public static byte[] getUTF8Bytes(String str) {
        return getBytesByCharset(str, StandardCharsets.UTF_8);
    }
    ...
    public static byte[] getISO8859Bytes(String str) {
        return getBytesByCharset(str, StandardCharsets.ISO_8859_1);
    }
     ...
     * [{key,value}]转换格式
     *
     * @param str [{stren_exp,0},{stren_lv,0}]
     * @return map
     */
    ...
    public static boolean isInteger(String integerString) {
        return searchByRegex(integerString, "^-?[0-9]\\d*$").length > 0;
    }
    ...
    public static boolean isFloat(String floadString) {
        return searchByRegex(floadString, "^-?[1-9]\\d*\\.\\d*|-0\\.\\d*[1-9]\\d*$").length > 0;
    }
}
