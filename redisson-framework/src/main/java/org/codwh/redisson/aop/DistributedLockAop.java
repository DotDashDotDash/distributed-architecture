...
public class DistributedLockAop {
    ...
    public Object aroundDLock(ProceedingJoinPoint joinPoint, DLock lock){
        ...
        long watchDogTimeout = lock.watchDogTimeout() == 0 ? config.getLockWatchdogTimeout() : lock.watchDogTimeout();
        long waitLockTimeout = lock.waitLockTimeout() == 0 ? watchDogTimeout : watchDogTimeout;
